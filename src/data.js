...
export const CONFIG = {
  siteName: 'BERGVAULT',
  domain: 'bergvault.ch',
  email: 'concierge@bergvault.ch',
  platformFeePercent: 15,
  mountainHeight: '4,478M', // Высота Маттерхорна
...
// MOCK DATABASE (Orders & Sellers)
export const MOCK_DB = {
  orders: [
    { id: 'BV-7782-X', customer: 'Alex Frei', amount: 899, status: 'shipped', date: '2025-05-15', items: 'Jungfrau Fluorite', tracking: 'CH-88219922' },
    { id: 'BV-9921-Z', customer: 'Sarah Miller', amount: 45, status: 'processing', date: '2025-05-16', items: 'Ceramic Mug', tracking: null },
  ],
  sellers: [
    { id: 1, name: 'Holzkunst Zermatt', sales: 12400, status: 'verified', joinDate: '2024-01-20' },
    { id: 2, name: 'Swiss Mineral Co.', sales: 4500, status: 'pending', joinDate: '2025-02-12' },
  ]
};
